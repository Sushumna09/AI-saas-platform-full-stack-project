...
const Hero = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative flex flex-col items-center justify-center w-full min-h-screen pt-32 bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat'>
